...
$additionalFields = array(
    'lg_country_iso_2' => 'll_iso639'
);
foreach ($additionalFields as $sourceField => $destField) {
    $additionalColumns = array();
    $additionalColumns[$destField] = $GLOBALS['TCA']['static_languages']['columns'][$sourceField];
    $additionalColumns[$destField]['label'] = 'LLL:EXT:static_info_tables_iso639/Resources/Private/Language/locallang_db.xlf:static_languages_item.' . $destField;
